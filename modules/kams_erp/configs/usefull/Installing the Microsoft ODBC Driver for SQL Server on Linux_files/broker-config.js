...
{m:"//msdn.microsoft.com/en-us",c:"inv_c_p246609455.js",f:0.0237,p:0}
,{m:"technet.microsoft.com/en-us",c:"inv_c_p246609455-technet.js",f:0.0479,p:0}
...
/*	,{m: 'channelincentivesbeta2.microsoft.com/CHIPUI', c: 'inv_c_p346231629-ja-jp.js', f: 0, p: 0  ,prereqs:{content:[{'element':'a','elementValue':'プライバシー','attrib':'','attribValue':''}],cookie:[]}}
	,{m: 'channelincentivesbeta2.microsoft.com/CHIPUI', c: 'inv_c_p346231629-pt-br.js', f: 0, p: 0  ,prereqs:{content:[{'element':'a','elementValue':'Privacidade e Cookies','attrib':'','attribValue':''}],cookie:[]}}
	,{m: 'channelincentivesbeta2.microsoft.com/CHIPUI', c: 'inv_c_p346231629-spanish.js', f: 0, p: 0  ,prereqs:{content:[{'element':'a','elementValue':'Privacidad y cookies','attrib':'','attribValue':''}],cookie:[]}}	
	,{m: 'channelincentivesbeta2.microsoft.com/CHIPUI', c: 'inv_c_p346231629-de-de.js', f: 0, p: 0  ,prereqs:{content:[{'element':'a','elementValue':'Datenschutz und Cookies','attrib':'','attribValue':''}],cookie:[]}}
  ,{m: 'channelincentivesbeta2.microsoft.com/CHIPUI', c: 'inv_c_p346231629-fr-fr.js', f: 0, p: 0  ,prereqs:{content:[{'element':'a','elementValue':'personnelles et cookies','attrib':'','attribValue':''}],cookie:[]}}		  
*/
],Events:{beforeRecruit:function(){var C=COMSCORE.SiteRecruit.Broker.config;
...
var B=COMSCORE.SiteRecruit.Utils.UserPersistence;if(B.getCookieValue(C.domainSwitch)!=false){B.createCookie(C.domainSwitch,"",{path:"/",domain:C.cookie.domain,duration:-1});
